...
window.CRYSTL_APPS = [
    ...
    },
    {
        ...
        "tagline": {
            "en": "Fast, physical arcade water polo you can play one-handed.",
            "ko": "한 손으로 즐기는 빠르고 박진감 넘치는 아케이드 수구.",
            "ja": "片手で遊べる、スピーディで激しいアーケード水球。"
        },
        "desc": {
            "en": "Water Polo Smash distills the sport into quick, punchy arcade matches — swim, pass, and smash shots past the keeper. Simple one-handed controls with real momentum and physicality, wrapped in a crystalline splash of art. Easy to learn, tough to master.",
            "ko": "워터 폴로 스매시는 수구를 빠르고 경쾌한 아케이드 경기로 압축했습니다. 헤엄치고, 패스하고, 골키퍼를 뚫는 슛을 날리세요. 한 손 조작에 실감 나는 물리 감각을 더했습니다. 배우기는 쉽고 마스터하기는 어렵습니다.",
            "ja": "ウォーターポロ・スマッシュは水球を素早く爽快なアーケード試合に凝縮。泳いで、パスして、キーパーを抜くシュートを叩き込もう。片手操作にリアルな物理挙動を融合。覚えるのは簡単、極めるのは難しい。"
        }
    },
    {
